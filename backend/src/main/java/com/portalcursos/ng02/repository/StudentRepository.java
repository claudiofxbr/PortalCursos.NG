...
public interface StudentRepository extends JpaRepository<Student, Long> {
    ...
    @org.springframework.data.jpa.repository.Query("SELECT s FROM Student s LEFT JOIN FETCH s.course LEFT JOIN FETCH s.creator LEFT JOIN FETCH s.documents WHERE s.id = :id AND s.active = true")
