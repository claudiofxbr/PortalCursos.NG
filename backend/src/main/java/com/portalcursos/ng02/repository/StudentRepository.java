...
public interface StudentRepository extends JpaRepository<Student, Long> {
    ...
    @org.springframework.data.jpa.repository.Query("SELECT DISTINCT s FROM Student s LEFT JOIN FETCH s.course LEFT JOIN FETCH s.creator WHERE s.active = true AND TYPE(s) = Student")
